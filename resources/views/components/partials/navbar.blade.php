<nav class="bg-white border-gray-200 dark:bg-gray-900">
    ...
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <button x-on:click="open = !open" data-collapse-toggle="navbar-user" type="button"
        ...
        <a href="/" class="flex items-center space-x-3 rtl:space-x-reverse">
            <img src="https://static.wixstatic.com/media/beceb7_a29f3ea1b7394a1bb6cde1098f48bfdf~mv2.png/v1/fill/w_106,h_154,al_c,q_85,usm_0.66_1.00_0.01,enc_avif,quality_auto/logo_cfls.png"
                alt="CFLS Logo" class=" w-16" />
        </a>
        <div class="flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
            ...
            <div x-data="themeToggle()" class="flex justify-end py-4 px-3">
        ...
        {{-- menu for web --}}
        <div class="items-center justify-between  w-full md:flex md:w-auto md:order-1 hidden" id="navbar-user">
            <ul
