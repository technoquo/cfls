<x-layout>
    ...
    <section class="bg-white dark:bg-gray-900">
        ...
        <div class="mx-auto max-w-screen-xl px-4 2xl:px-0">
            <h2 class="mb-4 text-7xl tracking-tight font-extrabold text-gray-900 dark:text-white text-center">Tables de conversation</h2>
            <div class="mb-4 flex items-center justify-between gap-4 md:mb-8">
                
                <div class="text-xl font-semibold text-gray-900 dark:text-white sm:text-2xl mb-4">Pour vous aider à pratiquer
            ...
            <div class="grid gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
                <a href="/"
                    ...
                    <div
                        class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Inscription</div>
                   </a>
