...
<section class="bg-white dark:bg-gray-900 mb-4" {{ $don->status ? '' : 'hidden' }}>
    <div class="max-w-screen-2xl px-4 py-8 mx-auto space-y-12">
        ...
        <div class="flex flex-col lg:grid lg:grid-cols-2 xl:gap-16 gap-8 items-center">
            ...
            <div class="order-1 lg:order-2 wow animate__animated animate__backInRight w-full">
                <img
                    class="w-full sm:w-10 md:w-2/3 mx-auto h-auto max-w-none rounded-md mb-6"
            ...
            <!-- Text Content -->
            <div class="order-2 lg:order-1 text-gray-700 sm:text-lg dark:text-gray-400 wow animate__animated animate__backInLeft w-full">
                <h2 class="mb-4 font-extrabold tracking-tight leading-none text-xl sm:text-2xl md:text-3xl lg:text-5xl xl:text-6xl 2xl:text-7xl dark:text-white text-black">
                    {{ $don->title }}
                </h2>
                <hr class="border-b border-gray-200 dark:border-gray-700 my-5" />
                <p class="mb-8 font-medium lg:text-xl text-gray-800 dark:text-white text-center">
                    {!! $don->description !!}
                </p>
                <!-- List -->
            </div>
