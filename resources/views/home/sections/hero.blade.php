    ...
    <div class="max-w-screen-2xl  mx-auto space-y-12">
        ...
        <div class="items-center gap-8 lg:grid lg:grid-cols-2 xl:gap-16">
            <div class="text-gray-700 sm:text-lg dark:text-gray-400">
                ...
                <p class="font-medium lg:text-2xl">{!! $history->description !!}</p>
                <!-- List -->

            </div>
            <div>
                <h2 class="mb-4 mt-8   md:text-3xl lg:text-5xl xl:text-6xl 2xl:text-7xl font-extrabold tracking-tight text-gray-900 dark:text-white text-center uppercase">{{ $history->title }}</h2>
