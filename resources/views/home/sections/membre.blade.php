...
{{--    </div>--}}
    ...
    <div class="grid max-w-screen-2xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
        ...
        <!-- Text & Image -->
        <div class="ml-auto place-self-center lg:col-span-7 wow animate__animate animate__bounceInDown ">
            <h1 class="mb-4 max-w-2xl text-center text-xl sm:text-2xl md:text-3xl lg:text-5xl xl:text-6xl 2xl:text-7xl font-extrabold tracking-tight leading-none  uppercase">
                {{ $members->title }}
            </h1>

            <div class="max-w-2xl mb-2 font-light lg:mb-4 md:text-lg lg:text-xl members-description mt-10">
                {!! $members->description !!}
            </div>
