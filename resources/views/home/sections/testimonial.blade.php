<section class="bg-white dark:bg-gray-900 py-12"
    ...
    <h2 class="text-center  font-semibold dark:text-white text-xl sm:text-2xl md:text-3xl lg:text-5xl xl:text-6xl 2xl:text-7xl uppercase mb-10">Témoignage</h2>
    <div class="max-w-screen-xl px-4 mx-auto overflow-hidden relative">
        ...
        <div class="flex transition-transform duration-700 ease-out"
            ...
            <template x-for="(testimonial, index) in testimonials" :key="index">
                <div class="flex-shrink-0 w-full text-center px-6 mb-10">
...
{{--                        </svg>--}}
                        <blockquote>
                            <p class="text-2xl   text-gray-900 dark:text-white" x-text="'\'' + testimonial.text + '\''"></p>
                        </blockquote>
