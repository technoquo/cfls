<!-- Encabezado superior con redes sociales y theme switch -->
<header class="w-full flex justify-between items-center px-4 py-2 bg-[#84DBF0]">
    <!-- Logo a la izquierda -->
    ...
    <div class="flex items-center space-x-4 ">
        ...
        <a href="https://wa.me/1234567890" target="_blank" class="hover:opacity-80">
            <svg class="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
                ...
                <path
                    d="M12.004 2.004a9.998 9.998 0 0 0-8.708 14.721L2 22l5.42-1.29a9.998 9.998 0 1 0 4.583-18.706zm0 18.175a8.177 8.177 0 0 1-4.166-1.147l-.298-.174-3.208.764.857-3.13-.197-.323a8.176 8.176 0 1 1 7.012 3.978z"></path>
            </svg>
...
<nav class="border-gray-200 dark:bg-gray-900 mb-7">
    <div class="flex flex-wrap items-center justify-between lg:justify-center mx-auto p-4 bg-[#84DBF0] w-full">
        ...
        <div id="navbar-user" class="hidden lg:flex w-full justify-center mt-4 lg:mt-0">
            @livewire('navigation')
        </div>
    </div>
</nav>
