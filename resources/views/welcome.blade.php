...
<body class="bg-gray-100 text-gray-800 font-sans antialiased min-h-screen flex items-center justify-center px-4">
<div class="bg-white rounded-lg shadow p-6 sm:p-8 max-w-lg w-full text-center">
    <img src="{{ asset('img/logo_cfls.png') }}" alt="Construction" class="mx-auto mb-6 w-32 sm:w-40 md:w-48">
    <h1 class="text-2xl sm:text-3xl font-bold mb-4">
        Nous construisons notre site web !
    </h1>
